...
void testSerial4() {
  ...
  while (Serial4.available()) {
    ...
    // Kui saime terve rea, printi see korraga
    if (c == '\n') {
      CONSOLE.print("Serial4 FULL LINE: ");
      CONSOLE.print(buffer);
      buffer = "";
    }
  }
  
  // Kui puhver liiga pikk (ei leidnud newline), printi ikkagi
  if (buffer.length() > 200) {
    CONSOLE.print("Serial4 BUFFER OVERFLOW: ");
