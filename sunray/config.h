...
#define GO_HOME_VOLTAGE   25 //21.5  // start going to dock below this voltage
// The battery will charge if both battery voltage is below that value and charging current is above that value.
#define BAT_FULL_VOLTAGE  29,2 //25.0  // start mowing again at this voltage
#define BAT_UNDERVOLTAGE  22.4 //18.9  // battery switch off voltage
...
// ------- I2C addresses -----------------------------
#define DS1307_ADDRESS B1101000   // DS1307 RTC address (I2C address 0x68) Clock
#define AT24C32_ADDRESS B1010000   // AT24C32 EEPROM address (I2C address 0x50) EEPROM
