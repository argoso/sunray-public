...
bool WatchdogSTM32::_enabled = false;
...
/**
  ...
  * @retval None
  */
void WatchdogSTM32::begin(uint32_t timeout, uint32_t window) { 
...
/**
  ...
  * @retval None
  */
void WatchdogSTM32::set(uint32_t timeout, uint32_t window)
{
...
/**
  ...
  * @retval None
  */
void WatchdogSTM32::get(uint32_t *timeout, uint32_t *window)
{
  if (timeout != NULL) {
...
/**
  ...
  * @retval None
  */
void WatchdogSTM32::reload(void)
{
  if (isEnabled()) {
    LL_IWDG_ReloadCounter(IWDG);
  }
...
/**
  ...
  */
bool WatchdogSTM32::isReset(bool clear)
{
#ifdef IWDG1
...
/**
  ...
  * @retval None
  */
void WatchdogSTM32::clearReset(void)
{
