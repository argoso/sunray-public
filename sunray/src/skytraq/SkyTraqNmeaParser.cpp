...
{
  CONSOLE.println("ProcessingGGA started");
  ...
  char q = GetParamChar(pt, commaPos[5] + 1, commaPos[6] - 1, 0);
    // LC29HEA quality codes might be different
  GnssData::QualityMode qualityMode = GetGgaQualityMode(q);
  CONSOLE.print("GGA Quality char: '");
  CONSOLE.print(q);
  CONSOLE.print("', parsed mode: ");
  CONSOLE.println(qualityMode);
