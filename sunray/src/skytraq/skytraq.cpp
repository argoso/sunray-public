...
{
  CONSOLE.print("GNSS UPDATED - Flag: ");
  CONSOLE.print(f, HEX);
  CONSOLE.print(", Type: ");
...
{
  CONSOLE.print("processNmea called - flags: ");
  CONSOLE.print(f, HEX);
  CONSOLE.print(", type: ");
  CONSOLE.println(type);
  ...
  for(; i < 32; ++i)
  {
    ...
    case SkyTraqNmeaParser::UpdateLatitude:
      CONSOLE.print("UpdateLatitude: ");
      CONSOLE.println(gnss.GetLatitude(), 8);
      lat = gnss.GetLatitude();            
      break;
    case SkyTraqNmeaParser::UpdateLongitude:
      lon = gnss.GetLongitude();
      CONSOLE.print("UpdateLongitude: ");
      CONSOLE.println(gnss.GetLongitude(), 8);
      //CONSOLE.print(",");
